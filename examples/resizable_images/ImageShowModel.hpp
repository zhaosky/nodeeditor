...
public:
    ...
    QString descriptions()const override {return QStringLiteral("Image Display");};
...
public:
    ...
    void setInData(std::shared_ptr<NodeData> nodeData, PortIndex const port,bool bContinueExec) override;
